    ...
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                ¿Ya tienes una cuenta? <a href="{{ route('ecommerce.login') }}" class="font-medium text-indigo-600 hover:text-indigo-500">Inicia sesión</a>
            </p>
        </div>
        ...
        <form class="mt-8 space-y-6" wire:submit.prevent="register">
            ...
            <div class="flex items-center">
                <input id="terms" name="terms" type="checkbox" wire:model="terms"
